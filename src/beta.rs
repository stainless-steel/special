...
mod test {
    ...
    fn inc_beta_small() {
        ...
        let x = vec![0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40,
                     ...
                     0.90, 0.95, 1.00];
        let y = vec![0.000000000000000e+00, 5.095391215346399e-01,
                     ...
                     6.705707961028990e-01, 6.816739425887479e-01,
                     6.928567823206671e-01, 7.043251807250750e-01,
                     7.163269829958610e-01, 7.291961263917867e-01,
                     7.434379555965913e-01, 7.599272566076309e-01,
    ...
    fn inc_beta_large() {
        ...
        let x = vec![0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40,
                     0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85,
                     0.90, 0.95, 1.00];
        let y = vec![0.000000000000000e+00, 1.401875000000000e-02,
    ...
    fn inv_inc_beta_small() {
        ...
        let x = vec![0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40,
                     0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85,
                     0.90, 0.95, 1.00];
        let y = vec![0.000000000000000e+00, 2.793072851850660e-06,
                     ...
                     2.391350361479824e-01, 3.527066234122371e-01,
                     4.840600731467657e-01, 6.206841200371190e-01,
                     7.474718280552188e-01, 8.514539745840592e-01,
                     9.257428898178934e-01, 9.707021084050310e-01,
    ...
    fn inv_inc_beta_large() {
        ...
        let x = vec![0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40,
                     0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85,
                     0.90, 0.95, 1.00];
        let y = vec![0.000000000000000e+00, 0.025320565519104e+00,
                     ...
                     0.292893218813452e+00, 0.329179606750063e+00,
                     0.367544467966324e+00, 0.408392021690038e+00,
                     0.452277442494834e+00, 0.500000000000000e+00,
                     0.552786404500042e+00, 0.612701665379257e+00,
